<?php
	...
	if(mysqli_num_rows($query) === 1) {
		...
		if(strpos($user, "b00") !== false) {
			...
			$data .= "<li class='form_row'><label for='first_name' class='form_title'>First Name:</label><input type='text' name='first_name' value='" . $first_name . "' pattern='[A-Za-z\\s]*' required></li>";
			$data .= "<li class='form_row'><label for='surname' class='form_title'>Surname:</label><input type='text' name='surname' value='" . $surname . "' pattern='[A-Za-z\\s]*' required></li>";
			$data .= "<li class='form_row'><label for='email' class='form_title'>Email:</label><input type='email' name='email' value='" . $email . "' required></li>";
